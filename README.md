...
4. Ao final de todos os jogos, o programa exibe um **Ranking Final**, ordenando os participantes do 1º ao 3º lugar (utilizando lógica de troca manual de variáveis `swap`).
